...
TEXTS = {
    "ru": {
        ...
        "blocked": (
            ...
            "Если это ошибка — напишите в поддержку, администратор рассмотрит запрос."
        ),
        "btn_blocked_support": "✉️ Написать в поддержку",
        "blocked_support_prompt": (
            "✉️ <b>Сообщение администратору</b>\n\n"
            "Опишите ситуацию одним сообщением. Администратор увидит ваш профиль "
            "и сможет восстановить доступ."
        ),
        "blocked_support_sent": (
            "✅ <b>Сообщение отправлено.</b>\n\n"
            "Если администратор одобрит — вам придёт уведомление, и доступ к боту "
            "будет восстановлен."
        ),
        "blocked_support_cancel": "Запрос отменён.",
    ...
    "en": {
        ...
        "blocked": (
            ...
            "If this is a mistake — message support, an admin will review it."
        ),
        "btn_blocked_support": "✉️ Message support",
        "blocked_support_prompt": "✉️ <b>Message to admin</b>\n\nDescribe the situation in one message.",
        "blocked_support_sent": "✅ Sent. If approved — access will be restored.",
        "blocked_support_cancel": "Cancelled.",
